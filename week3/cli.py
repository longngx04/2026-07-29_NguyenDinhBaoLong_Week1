...
Provides analyze and validate subcommands with strict exit code mappings according to Phase 5 spec.
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    validate_parser.add_argument("--input", type=Path, default=Path("results/analysis/security-analysis.jsonl"), help="Input JSONL file")

...
import pytest
from week3.input_loader import load_findings


def test_load_findings_valid():
    fixture_path = Path(__file__).parent.parent.parent / "fixtures" / "week3" / "valid-findings.json"
...
def test_load_findings_invalid_structure():
    fixture_path = Path(__file__).parent.parent.parent / "fixtures" / "week3" / "invalid-findings.json"
